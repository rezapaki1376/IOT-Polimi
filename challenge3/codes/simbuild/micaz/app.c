...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bf6458, const void *arg_0xb7bf65f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7ba78c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a51840), 
int (*key_eq_fn)(void *arg_0xb7a51c88, void *arg_0xb7a51e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79209b8, int arg_0xb7920b10);
static double RandomUniform(void );
...
# 40 "RadioRouteC.nc"
#line 36
typedef nx_struct RadioRouteC$rt_struct {
  nx_uint16_t destination;
  nx_uint16_t Next_Hop;
  nx_uint16_t cost;
} __attribute__((packed)) RadioRouteC$rt_struct;

RadioRouteC$rt_struct RadioRouteC$routing_table[1000][6];
...
const char *RadioRouteC$student_id[1000];
uint16_t RadioRouteC$Node6_LED_status[1000][30];

bool RadioRouteC$msg_sent_flag[1000];

uint16_t RadioRouteC$msgs_number[1000];

uint8_t RadioRouteC$rt_elements[1000];
...
static void RadioRouteC$Route_Req_Msg(uint16_t node_requested);
static void RadioRouteC$Route_Rep_Msg(uint16_t node_requested, uint16_t cost);
static void RadioRouteC$Data_Message_Send(uint16_t dest, uint16_t value);
static uint8_t RadioRouteC$Dest_searching(uint16_t dest);

static inline void RadioRouteC$routing_table_initialize(void );
...
#line 275
    {
      uint8_t LED_index = RadioRouteC$student_id[sim_node()][RadioRouteC$msgs_number[sim_node()] % 8] % 3;
      ...
      RadioRouteC$msgs_number[sim_node()]++;
      ...
      if (TOS_NODE_ID == 6) {
          sim_log_debug(156U, "node6_leds", " message of type %u received by node 6. save the LEDs status\n", __nesc_ntoh_uint8(rcm->type.nxdata));
          RadioRouteC$Node6_LED_status[sim_node()][RadioRouteC$msgs_number[sim_node()] * 3 + 0] = (RadioRouteC$Leds$get() & LEDS_LED0) > 0;
          RadioRouteC$Node6_LED_status[sim_node()][RadioRouteC$msgs_number[sim_node()] * 3 + 1] = (RadioRouteC$Leds$get() & LEDS_LED1) > 0;
          RadioRouteC$Node6_LED_status[sim_node()][RadioRouteC$msgs_number[sim_node()] * 3 + 2] = (RadioRouteC$Leds$get() & LEDS_LED2) > 0;
        }

      while (TOS_NODE_ID == 6 && k <= RadioRouteC$msgs_number[sim_node()] * 3 + 2) {
          if (k == 0) {
            sim_log_debug_clear(157U, "node6_leds", "Node 6 LEDs status:\n");
            }
          sim_log_debug_clear(158U, "node6_leds", "%u", RadioRouteC$Node6_LED_status[sim_node()][k]);
          k++;
        }
      sim_log_debug_clear(159U, "node6_leds", "\n\n");
      ...
      switch (__nesc_ntoh_uint8(rcm->type.nxdata)) {
          case 0: 
            ...
            if (__nesc_ntoh_uint16(rcm->destination.nxdata) == TOS_NODE_ID) {
                sim_log_debug(160U, "radio_pack", "Data message received by the destination node: %u with the value of: %u\n", __nesc_ntoh_uint16(rcm->destination.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata));
              }
            else 
              {
                RadioRouteC$Data_Message_Send(__nesc_ntoh_uint16(rcm->destination.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata));
              }
          break;
          case 1: 


            rt_currentIndex = RadioRouteC$Dest_searching(__nesc_ntoh_uint16(rcm->destination.nxdata));

          if (__nesc_ntoh_uint16(rcm->destination.nxdata) != TOS_NODE_ID && rt_currentIndex == 0) {
              RadioRouteC$Route_Req_Msg(__nesc_ntoh_uint16(rcm->destination.nxdata));
            }
          else {
            if (__nesc_ntoh_uint16(rcm->destination.nxdata) == TOS_NODE_ID) {

                RadioRouteC$Route_Rep_Msg(__nesc_ntoh_uint16(rcm->destination.nxdata), 1);
              }
            else {
              if (rt_currentIndex != 0) {

                  RadioRouteC$Route_Rep_Msg(__nesc_ntoh_uint16(rcm->destination.nxdata), __nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][rt_currentIndex - 1].cost.nxdata) + 1);
                }
              }
            }
#line 346
          ...
          if (rt_currentIndex == 0) {
              ...
              __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][RadioRouteC$rt_elements[sim_node()]].destination.nxdata, __nesc_ntoh_uint16(rcm->destination.nxdata));
              __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][RadioRouteC$rt_elements[sim_node()]].Next_Hop.nxdata, __nesc_ntoh_uint16(rcm->sender.nxdata));
              __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][RadioRouteC$rt_elements[sim_node()]].cost.nxdata, __nesc_ntoh_uint16(rcm->value.nxdata));
              RadioRouteC$rt_elements[sim_node()]++;
              if (TOS_NODE_ID != 1) {
                RadioRouteC$Route_Rep_Msg(__nesc_ntoh_uint16(rcm->destination.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata) + 1);
                }
            }
          else {
#line 361
            if (__nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][rt_currentIndex - 1].cost.nxdata) > __nesc_ntoh_uint16(rcm->value.nxdata)) {
                __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][rt_currentIndex - 1].destination.nxdata, __nesc_ntoh_uint16(rcm->destination.nxdata));
                __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][rt_currentIndex - 1].cost.nxdata, __nesc_ntoh_uint16(rcm->value.nxdata) + 1);
                __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][rt_currentIndex - 1].Next_Hop.nxdata, __nesc_ntoh_uint16(rcm->sender.nxdata));
                if (TOS_NODE_ID != 1) {
                  RadioRouteC$Route_Rep_Msg(__nesc_ntoh_uint16(rcm->destination.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata) + 1);
                  }
              }
...
#line 369
          if (TOS_NODE_ID == 1) {
              RadioRouteC$Data_Message_Send(7, 5);
            }
          break;
        }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76c1298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76c1298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76c1298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76c1930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76c1930, msg, payload, len);
#line 78
...
#line 241
{
  if (err == SUCCESS) {
    ...
    {
      sim_log_error(154U, "radio", "Radio failed to start, retrying...\n");
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76d08b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76d08b0, msg, error);
#line 110
}
#line 110
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb787c650){
#line 75
  switch (arg_0xb787c650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb787c650);
#line 75
      break;
#line 75
    }
...
#line 212
{
  ...
  if (!RadioRouteC$locked[sim_node()]) {
      if (RadioRouteC$AMSend$send(address, packet, sizeof(radio_route_msg_t )) == SUCCESS) {
          ...
          sim_log_debug_clear(151U, "radio_send", " sending packet at time %s \n", sim_time_string());
        }
    }
  else 
    {
...
#line 259
  rt_currentIndex = RadioRouteC$Dest_searching(7);

  if (rt_currentIndex == 0) {

      RadioRouteC$Route_Req_Msg(7);
    }
  else {
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb73913a8){
#line 83
  switch (arg_0xb73913a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb73913a8);
#line 83
      break;
#line 83
    }
...
#line 76
  for (k = 0; k < 6; k++) {
      __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][k].destination.nxdata, 0);
      __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][k].Next_Hop.nxdata, 0);
      __nesc_hton_uint16(RadioRouteC$routing_table[sim_node()][k].cost.nxdata, 0);
    }
}
...
#line 229
{
  ...
  RadioRouteC$routing_table_initialize();
  RadioRouteC$AMControl$start();

  if (TOS_NODE_ID == 1) {
      RadioRouteC$Timer1$startOneShot(5000);
      sim_log_debug(153U, "timer", "application have booted and timer1 called.\n");
    }
}
...
#line 95
{
  if (!RadioRouteC$msg_sent_flag[sim_node()]) {
      uint8_t rt_currentIndex = RadioRouteC$Dest_searching(dest);

      uint8_t type = 0;

      radio_route_msg_t *rcm = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));
...
#line 102
      ...
      __nesc_hton_uint8(rcm->type.nxdata, type);

      __nesc_hton_uint16(rcm->sender.nxdata, TOS_NODE_ID);

      __nesc_hton_uint16(rcm->destination.nxdata, dest);

      __nesc_hton_uint16(rcm->value.nxdata, value);
      RadioRouteC$generate_send(__nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][rt_currentIndex - 1].Next_Hop.nxdata), &RadioRouteC$packet[sim_node()], type);
      RadioRouteC$msg_sent_flag[sim_node()] = TRUE;
      sim_log_debug(148U, "radio_send", "Data message generated with type: %u\tand destination: %u\tand sender: %u\tand value: %u \n", __nesc_ntoh_uint8(rcm->type.nxdata), __nesc_ntoh_uint16(rcm->destination.nxdata), __nesc_ntoh_uint16(rcm->sender.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata));
    }
}
...
#line 82
{
  ...
  if (RadioRouteC$rt_elements[sim_node()] != 0) {
      for (k = 0; k < RadioRouteC$rt_elements[sim_node()]; k++) {
          if (__nesc_ntoh_uint16(RadioRouteC$routing_table[sim_node()][k].destination.nxdata) == dest) {
              return k + 1;
            }
          else {
              return 0;
...
#line 127
      ...
      __nesc_hton_uint16(rcm->sender.nxdata, 0);

      __nesc_hton_uint16(rcm->destination.nxdata, node_requested);

      __nesc_hton_uint16(rcm->value.nxdata, 0);

      RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], type);
      sim_log_debug(149U, "radio_send", "route request message generated with type: %u\tand destination: %u \n", __nesc_ntoh_uint8(rcm->type.nxdata), __nesc_ntoh_uint16(rcm->destination.nxdata));
    }
}
...
#line 151
      ...
      __nesc_hton_uint16(rcm->sender.nxdata, (uint16_t )TOS_NODE_ID);

      __nesc_hton_uint16(rcm->destination.nxdata, node_requested);

      __nesc_hton_uint16(rcm->value.nxdata, cost);

      RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], type);
      sim_log_debug(150U, "radio_send", "route reply message generated with type: %u\tand destination: %u\tand sender: %u\tand value: %u \n", __nesc_ntoh_uint8(rcm->type.nxdata), __nesc_ntoh_uint16(rcm->destination.nxdata), __nesc_ntoh_uint16(rcm->sender.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata));
    }
}
...
#line 382
{
  ...
  if (&RadioRouteC$queued_packet[sim_node()] == bufPtr) {
      ...
      sim_log_debug(161U, "radio_send", "Packet sent at time %s \n", sim_time_string());
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioRouteC$student_id"))
  {
    *addr = (uintptr_t)&RadioRouteC$student_id[__nesc_mote];
    *size = sizeof(RadioRouteC$student_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$Node6_LED_status"))
  {
    *addr = (uintptr_t)&RadioRouteC$Node6_LED_status[__nesc_mote];
    *size = sizeof(RadioRouteC$Node6_LED_status[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$msg_sent_flag"))
  {
    *addr = (uintptr_t)&RadioRouteC$msg_sent_flag[__nesc_mote];
    *size = sizeof(RadioRouteC$msg_sent_flag[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$msgs_number"))
  {
    *addr = (uintptr_t)&RadioRouteC$msgs_number[__nesc_mote];
    *size = sizeof(RadioRouteC$msgs_number[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$rt_elements"))
  {
    *addr = (uintptr_t)&RadioRouteC$rt_elements[__nesc_mote];
    *size = sizeof(RadioRouteC$rt_elements[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  RadioRouteC$student_id[__nesc_mote] = "10832693";
  memset((void *)&RadioRouteC$Node6_LED_status[__nesc_mote], 0, sizeof RadioRouteC$Node6_LED_status[__nesc_mote]);
  RadioRouteC$msg_sent_flag[__nesc_mote] = FALSE;
  RadioRouteC$msgs_number[__nesc_mote] = 0;
  RadioRouteC$rt_elements[__nesc_mote] = 0;
