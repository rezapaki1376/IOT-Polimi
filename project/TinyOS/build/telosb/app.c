...
extern int memcmp(const void *arg_0xb7c4e690, const void *arg_0xb7c4e828, size_t arg_0xb7c4e9c0);
extern void *memcpy(void *arg_0xb7c4ee68, const void *arg_0xb7c4c030, size_t arg_0xb7c4c1c8);

extern void *memset(void *arg_0xb7c4ce90, int arg_0xb7c4b010, size_t arg_0xb7c4b1a8);
#line 65
extern void *memset(void *arg_0xb7c3fd30, int arg_0xb7c3fe88, size_t arg_0xb7c3e030);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0xb7c1c3b8);
  ...
  void (**_sig_func)(int arg_0xb7c19a70);
...
typedef TMilli MqttC__TimerSub__precision_tag;
typedef TMilli MqttC__TimerNextPub__precision_tag;
typedef TMilli MqttC__TimerConn__precision_tag;
typedef TMilli MqttC__TimerNextSub__precision_tag;
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void MqttC__TimerSub__fired(void );
#line 83
static void MqttC__TimerNextPub__fired(void );
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void MqttC__TimerConn__fired(void );
#line 83
static void MqttC__TimerNextSub__fired(void );
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool MqttC__Timer0__isRunning(void );
#line 73
...
uint8_t len);
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool MqttC__TimerSub__isRunning(void );
#line 73
static void MqttC__TimerSub__startOneShot(uint32_t dt);




static void MqttC__TimerSub__stop(void );
#line 73
static void MqttC__TimerNextPub__startOneShot(uint32_t dt);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t MqttC__Random__rand16(void );
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool MqttC__TimerConn__isRunning(void );
#line 73
static void MqttC__TimerConn__startOneShot(uint32_t dt);




static void MqttC__TimerConn__stop(void );
#line 73
static void MqttC__TimerNextSub__startOneShot(uint32_t dt);
# 31 "MqttC.nc"
message_t MqttC__packet;
message_t MqttC__queued_packet;
uint16_t MqttC__queue_addr;
uint16_t MqttC__time_delays[9] = { 61, 173, 267, 371, 479, 583, 689, 800, 913 };


bool MqttC__connection_status = FALSE;

bool MqttC__current_sub_status = FALSE;

uint8_t MqttC__subscribed_topic_index = 0;

uint16_t MqttC__connection_status_devices[10];

uint8_t MqttC__cd_index = 0;


const uint8_t MqttC__TEMPRATURE = 1;
const uint8_t MqttC__HUMIDITY = 2;
const uint8_t MqttC__LUMINOSITY = 3;


uint8_t MqttC__publish_topic = 0;
int MqttC__sent_index[3] = { -1, -1, -1 };

uint16_t MqttC__message_queue[3] = { 0, 0, 0 };

uint8_t MqttC__message_list[3] = { 0, 0, 0 };

bool MqttC__locked;



uint8_t MqttC__subscribed_topic[3] = { 0, 0, 0 };

bool MqttC__subscription_matrix[3][8] = { 
...
static void MqttC__send_connect_msg(void );
static inline void MqttC__send_connect_msg_ack(uint16_t dest);
static void MqttC__sub_msg_send(uint8_t topic);
static inline void MqttC__send_connect_msg_ack(uint16_t dest);
static inline void MqttC__send_pub_msg(void );
static void MqttC__publish(void );
static inline bool MqttC__actual_send(uint16_t address, message_t *packet);


static bool MqttC__generate_send(uint16_t address, message_t *packet);
...
static inline void MqttC__TimerConn__fired(void );
...
static inline void MqttC__TimerSub__fired(void );
...
static inline void MqttC__TimerNextSub__fired(void );
#line 213
static inline void MqttC__TimerNextPub__fired(void );
...
static void MqttC__sub_msg_send(uint8_t topic);
#line 276
static inline void MqttC__sub_msg_ack(uint16_t dest, uint8_t topic);
#line 292
static inline void MqttC__send_pub_msg(void );
#line 310
static void MqttC__publish(void );
...
#line 488
static void MqttC__AMSend__sendDone(message_t *bufPtr, error_t error);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
static inline error_t /*MqttAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0xb7892788){
#line 39
  switch (arg_0xb7892788) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0xb7892788);
#line 39
      break;
#line 39
    }
...
# 88 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0xb6e40148, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0xb6e40148, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0xb72e8718){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  switch (arg_0xb72e8718) {
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0xb72e8718);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0xb72e61b8){
#line 39
  union __nesc_unnamed4282 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0xb72e61b8);
#line 39
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0xb71d0430){
#line 59
  switch (arg_0xb71d0430) {
#line 59
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0xb71d0430);
#line 59
      break;
#line 59
    }
...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0xb71d1010){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0xb71d1010);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0xb72e8718){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0xb72e8718);
#line 97
      break;
#line 97
    }
...
# 53 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0xb71d1010){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0xb71d1010);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0xb72e8718){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0xb72e8718);
#line 88
      break;
#line 88
    }
...
# 65 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0xb71d0430){
#line 65
  switch (arg_0xb71d0430) {
#line 65
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0xb71d0430);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0xb72e8718){
#line 120
  unsigned char __nesc_result;
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0xb72e8718);
#line 120
      break;
#line 120
    }
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0xb6c17c60, message_t * msg, error_t error){
#line 100
  switch (arg_0xb6c17c60) {
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0xb6c17c60, msg, error);
#line 100
      break;
#line 100
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0xb6c17620, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb6c17620) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0xb6c17620, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 65 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0xb71d0430){
#line 65
  switch (arg_0xb71d0430) {
#line 65
...
#line 65
    default:
#line 65
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0xb71d0430);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0xb6da7460){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0xb6da7460) {
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0xb6da7460);
#line 120
      break;
#line 120
    }
...
# 128 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0xb6da7460){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0xb6da7460);
#line 128
      break;
#line 128
    }
...
# 97 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0xb6da7460){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0xb6da7460);
#line 97
      break;
#line 97
    }
...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0xb71d1010){
#line 61
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0xb71d1010);
#line 61
}
#line 61
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0xb6da7eb8){
#line 39
  union __nesc_unnamed4286 *__nesc_result;
#line 39

#line 39
  switch (arg_0xb6da7eb8) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0xb6da7eb8);
#line 39
      break;
#line 39
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0xb6dade38){
#line 102
  switch (arg_0xb6dade38) {
#line 102
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0xb6dade38);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0xb71d2520){
#line 102
  switch (arg_0xb71d2520) {
#line 102
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0xb71d2520);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0xb71d0430){
#line 59
  switch (arg_0xb71d0430) {
#line 59
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0xb71d0430);
#line 59
      break;
#line 59
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0xb6e95628){
#line 102
  switch (arg_0xb6e95628) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0xb6e95628);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0xb6e41a98, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0xb6e41a98, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0xb6e40148, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0xb6e40148, msg);
#line 95
}
#line 95
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static bool MqttC__Timer0__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 171
{
  ...
  if (!MqttC__connection_status) {
      ;
      MqttC__send_connect_msg();
    }
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0xb77520a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0xb77520a0, addr, msg, len);
#line 80
...
#line 93
{
  if (MqttC__locked) {
      ...
      if (MqttC__AMSend__send(address, packet, sizeof(mqtt_packet_t )) == SUCCESS) {
...
#line 166
{
  MqttC__actual_send(MqttC__queue_addr, &MqttC__queued_packet);
}
...
#line 179
{
  ...
  if (!MqttC__current_sub_status) {
      ;

      MqttC__sub_msg_send(MqttC__subscribed_topic[MqttC__subscribed_topic_index]);
    }
}
...
#line 191
  if (MqttC__subscribed_topic_index < 3) {
      if (MqttC__subscribed_topic[MqttC__subscribed_topic_index] != 0) {
          ;
          MqttC__current_sub_status = FALSE;
          MqttC__sub_msg_send(MqttC__subscribed_topic[MqttC__subscribed_topic_index]);
        }
      else 
        {
...
#line 200
  ...
  if (finished == TRUE && MqttC__publish_topic != 0) {
      MqttC__TimerNextPub__startOneShot(5000);
    }
}
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t MqttC__Random__rand16(void ){
#line 52
  unsigned int __nesc_result;
#line 52
...
#line 292
{
  mqtt_packet_t *pub_msg = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));

#line 294
  if (pub_msg == (void *)0) {
      return;
    }
  __nesc_hton_uint8(pub_msg->type.nxdata, PUB);
  __nesc_hton_uint16(pub_msg->sender.nxdata, (uint16_t )TOS_NODE_ID);
  __nesc_hton_uint8(pub_msg->topic.nxdata, MqttC__publish_topic);

  __nesc_hton_uint16(pub_msg->value.nxdata, MqttC__Random__rand16() % 100);

  MqttC__TimerNextPub__startOneShot(3000);

  ;
  MqttC__generate_send(1, &MqttC__packet);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0xb6f399f0){
#line 83
  switch (arg_0xb6f399f0) {
#line 83
    case 1U:
#line 83
      MqttC__TimerConn__fired();
#line 83
      break;
#line 83
    case 2U:
...
#line 83
    case 3U:
#line 83
      MqttC__TimerSub__fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      MqttC__TimerNextSub__fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      MqttC__TimerNextPub__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0xb6f399f0);
#line 83
      break;
#line 83
    }
...
#line 83
#line 73
inline static void MqttC__TimerSub__startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(3U, dt);
#line 73
}
#line 73
inline static void MqttC__TimerConn__startOneShot(uint32_t dt){
#line 73
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0xb6e42088, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0xb6e42088, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void MqttC__TimerSub__stop(void ){
#line 78
...
#line 78
#line 92
inline static bool MqttC__TimerSub__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 276
{
  mqtt_packet_t *suback_msg = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));

#line 278
  if (suback_msg == (void *)0) {
      return;
    }
  __nesc_hton_uint8(suback_msg->type.nxdata, SUBACK);
  __nesc_hton_uint16(suback_msg->sender.nxdata, (uint16_t )TOS_NODE_ID);
  __nesc_hton_uint8(suback_msg->topic.nxdata, topic);
  __nesc_hton_uint16(suback_msg->value.nxdata, 0);
  ;
  MqttC__generate_send(dest, &MqttC__packet);
}

# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void MqttC__TimerConn__stop(void ){
#line 78
...
#line 78
#line 92
inline static bool MqttC__TimerConn__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 238
{
  mqtt_packet_t *conn_ack = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));
...
#line 240
  ...
  __nesc_hton_uint8(conn_ack->type.nxdata, CONNACK);
  __nesc_hton_uint16(conn_ack->sender.nxdata, (uint16_t )TOS_NODE_ID);

  __nesc_hton_uint8(conn_ack->topic.nxdata, 0);
  __nesc_hton_uint16(conn_ack->value.nxdata, 0);
  ;
  MqttC__generate_send(dest, &MqttC__packet);
}
...
#line 383
    {
      ...
      if (__nesc_ntoh_uint8(msg->type.nxdata) == CONN && TOS_NODE_ID == 1) {
          uint8_t i;
...
#line 389
          ...
          for (i = 0; i < MqttC__cd_index; i++) {
              if (MqttC__connection_status_devices[MqttC__cd_index] == __nesc_ntoh_uint16(msg->sender.nxdata)) {
          ...
          if (!already_connection_status) {
              ...
              MqttC__connection_status_devices[MqttC__cd_index] = __nesc_ntoh_uint16(msg->sender.nxdata);
              MqttC__cd_index++;
            }

          MqttC__send_connect_msg_ack(__nesc_ntoh_uint16(msg->sender.nxdata));
        }
      else {
        if (__nesc_ntoh_uint8(msg->type.nxdata) == CONNACK && TOS_NODE_ID != 1 && MqttC__TimerConn__isRunning()) {
            MqttC__TimerConn__stop();
            ;
            MqttC__connection_status = TRUE;

            MqttC__TimerNextSub__startOneShot(5000);
          }
        else {
          if (__nesc_ntoh_uint8(msg->type.nxdata) == SUB && TOS_NODE_ID == 1) {
              uint8_t i;
              ...
              for (i = 0; i < MqttC__cd_index; i++) {
                  if (MqttC__connection_status_devices[i] == __nesc_ntoh_uint16(msg->sender.nxdata)) {
              ...
              if (node_connection_status) {
                  if (!MqttC__subscription_matrix[__nesc_ntoh_uint8(msg->topic.nxdata) - 1][__nesc_ntoh_uint16(msg->sender.nxdata) - 2]) {
                      ;
                      MqttC__subscription_matrix[__nesc_ntoh_uint8(msg->topic.nxdata) - 1][__nesc_ntoh_uint16(msg->sender.nxdata) - 2] = TRUE;
                    }
                  MqttC__sub_msg_ack(__nesc_ntoh_uint16(msg->sender.nxdata), __nesc_ntoh_uint8(msg->topic.nxdata));
                }
            }
          else {
            if (__nesc_ntoh_uint8(msg->type.nxdata) == SUBACK && TOS_NODE_ID != 1 && MqttC__TimerSub__isRunning()) {
                if (MqttC__subscribed_topic[MqttC__subscribed_topic_index] == __nesc_ntoh_uint8(msg->topic.nxdata)) {
                    MqttC__TimerSub__stop();
                    ;
                    MqttC__current_sub_status = TRUE;
                    MqttC__subscribed_topic_index++;
                    MqttC__TimerNextSub__startOneShot(5000);
                  }
              }
            else {
              if (__nesc_ntoh_uint8(msg->type.nxdata) == PUB && TOS_NODE_ID == 1) {
                  uint8_t i;
                  bool node_connection_status = FALSE;
                  ...
                  if (node_connection_status) {
                      MqttC__message_queue[__nesc_ntoh_uint8(msg->topic.nxdata) - 1] = __nesc_ntoh_uint16(msg->value.nxdata);
                      MqttC__sent_index[__nesc_ntoh_uint8(msg->topic.nxdata) - 1] = 0;

                      for (i = 0; i < 3; i++) {
                          if (MqttC__message_list[i] == __nesc_ntoh_uint8(msg->topic.nxdata)) {
#line 465
                            break;
                            }
#line 466
                          if (MqttC__message_list[i] == 0) {
                              MqttC__message_list[i] = __nesc_ntoh_uint8(msg->topic.nxdata);
                            }
                        }
                      ;


                      printf("%u %u\n", __nesc_ntoh_uint8(msg->topic.nxdata), __nesc_ntoh_uint16(msg->value.nxdata));
                      printfflush();
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0xb6e449d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb6e449d0) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0xb6e449d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0xb72ea2f8){
#line 102
  switch (arg_0xb72ea2f8) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0xb72ea2f8);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0xb71d2520){
#line 102
  switch (arg_0xb71d2520) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0xb71d2520);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-main-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0xb72e9ea8, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0xb72e9ea8) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0xb72e9ea8, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0xb737e010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0xb737e010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0xb737e010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0xb6e40148, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0xb6e40148, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0xb737e010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0xb737e010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0xb737e010, data, length, error);
#line 91
      break;
#line 91
    }
...
#line 100
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0xb6e44010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0xb6e44010, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0xb77536a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb77536a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0xb77536a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 110
{
  ...
  if (TOS_NODE_ID == 2) {
      MqttC__subscribed_topic[1] = MqttC__HUMIDITY;

      MqttC__publish_topic = MqttC__TEMPRATURE;
    }

  if (TOS_NODE_ID == 3) {
      MqttC__subscribed_topic[0] = MqttC__TEMPRATURE;
    }
  ...
  if (TOS_NODE_ID == 4) {
      ...
      MqttC__publish_topic = MqttC__LUMINOSITY;
    }

  if (TOS_NODE_ID == 5) {
      MqttC__subscribed_topic[0] = MqttC__HUMIDITY;
      MqttC__subscribed_topic[1] = MqttC__LUMINOSITY;
    }

  if (TOS_NODE_ID == 6) {
      MqttC__publish_topic = MqttC__HUMIDITY;
    }

  if (TOS_NODE_ID == 7) {
      MqttC__subscribed_topic[0] = MqttC__LUMINOSITY;
      MqttC__subscribed_topic[0] = MqttC__TEMPRATURE;
...
# 54 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0xb71f70c0, uint8_t data){
#line 54
  switch (arg_0xb71f70c0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0xb71f70c0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0xb71f7940){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0xb71f7940);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0xb71f70c0){
#line 49
  switch (arg_0xb71f70c0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0xb71f70c0);
#line 49
      break;
#line 49
    }
...
# 79 "/opt/tinyos-main-2.1.2/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0xb6da8010, uint8_t byte){
#line 79
  switch (arg_0xb6da8010) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0xb6da8010, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0xb6da8010, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0xb6da8010) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0xb6da8010, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0xb71f70c0, uint8_t data){
#line 54
  switch (arg_0xb71f70c0) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0xb71f70c0, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0xb6da8010, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0xb6da8010) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0xb6da8010, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0xb71f70c0){
#line 49
  switch (arg_0xb71f70c0) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0xb71f70c0);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0xb7892788){
#line 39
  switch (arg_0xb7892788) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0xb7892788);
#line 39
      break;
#line 39
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0xb795eb40){
#line 75
  switch (arg_0xb795eb40) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0xb795eb40);
#line 75
      break;
#line 75
    }
...
#line 488
{
  if (&MqttC__queued_packet == bufPtr) {
      MqttC__locked = FALSE;
      if (TOS_NODE_ID == 1) {
          uint8_t i;
...
#line 310
{
  uint8_t topic = MqttC__message_list[0];
  int i;
...
#line 316
  ...
  if (MqttC__message_list[0] == 0 && MqttC__message_list[1] == 0 && MqttC__message_list[2] == 0) {
#line 320
    return;
    }
#line 321
  if (MqttC__sent_index[0] < 0 && MqttC__sent_index[1] < 0 && MqttC__sent_index[2] < 0) {
#line 321
    return;
    }
  if (topic == 0 || MqttC__sent_index[topic - 1] < 0) {
      MqttC__message_list[0] = MqttC__message_list[1];
      MqttC__message_list[1] = MqttC__message_list[2];
      MqttC__message_list[2] = 0;
      return MqttC__publish();
    }

  for (i = MqttC__sent_index[topic - 1]; i < 8; i++) {

      if (MqttC__subscription_matrix[topic - 1][i]) {
          destination = i + 2;
          MqttC__sent_index[topic - 1] = i + 1;
          finished = FALSE;
          break;
        }
    }
  ...
  if (finished) {
  ...
  else 
    {
      ...
      __nesc_hton_uint8(pub_msg->topic.nxdata, topic);

      __nesc_hton_uint16(pub_msg->value.nxdata, MqttC__message_queue[topic - 1]);

      ;
      MqttC__generate_send(destination, &MqttC__packet);
    }
}
...
#line 82
{
  if (MqttC__Timer0__isRunning()) {
      return FALSE;
    }
  else {
      MqttC__Timer0__startOneShot(MqttC__time_delays[TOS_NODE_ID - 1]);
      MqttC__queued_packet = *packet;
      MqttC__queue_addr = address;
    }
  return TRUE;
}
...
#line 258
{
  mqtt_packet_t *sub_msg = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));
...
#line 260
  ...
  __nesc_hton_uint8(sub_msg->type.nxdata, SUB);

  __nesc_hton_uint16(sub_msg->sender.nxdata, (uint16_t )TOS_NODE_ID);

  __nesc_hton_uint8(sub_msg->topic.nxdata, topic);

  __nesc_hton_uint16(sub_msg->value.nxdata, 0);
  MqttC__TimerSub__startOneShot(5000);
  ;
  MqttC__generate_send(1, &MqttC__packet);
}
...
#line 220
{
  mqtt_packet_t *connect_msg = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));
...
#line 222
  ...
  __nesc_hton_uint8(connect_msg->type.nxdata, CONN);

  __nesc_hton_uint16(connect_msg->sender.nxdata, (uint16_t )TOS_NODE_ID);

  __nesc_hton_uint8(connect_msg->topic.nxdata, 0);
  __nesc_hton_uint16(connect_msg->value.nxdata, 0);
  MqttC__TimerConn__startOneShot(5000);
  ;
  MqttC__generate_send(1, &MqttC__packet);
}
