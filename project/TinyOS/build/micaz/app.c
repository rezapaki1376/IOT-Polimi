...
extern int memcmp(const void *arg_0xb7cbe728, const void *arg_0xb7cbe8c0, size_t arg_0xb7cbea58) __attribute((__pure__)) ;
extern void *memcpy(void *arg_0xb7cbc010, const void *arg_0xb7cbc1a8, size_t arg_0xb7cbc340);



extern void *memset(void *arg_0xb7cb9350, int arg_0xb7cb94a8, size_t arg_0xb7cb9640);
...
typedef int (*__compar_fn_t)(const void *arg_0xb7ca7730, const void *arg_0xb7ca78c8);
...
const uint16_t MqttC__timeout = 5000;
...
static void MqttC__send_conn(void );
static inline void MqttC__send_connack(uint16_t dest);
bool MqttC__connected = FALSE;
uint16_t MqttC__connected_devices[10];
uint8_t MqttC__cd_index = 0;

const uint8_t MqttC__TEMPERATURE = 1;
const uint8_t MqttC__HUMIDITY = 2;
const uint8_t MqttC__LUMINOSITY = 3;
bool MqttC__current_sub = FALSE;
bool MqttC__subscribed[3] = { FALSE, FALSE, FALSE };
uint8_t MqttC__interested_topics[3] = { 0, 0, 0 };
bool MqttC__subscribed_topics[3][8] = { 
{ FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE }, 
{ FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE }, 
{ FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE } };

uint8_t MqttC__it_index = 0;
static void MqttC__send_sub(uint8_t topic);
static inline void MqttC__send_connack(uint16_t dest);
...
static void MqttC__send_sub(uint8_t topic);
#line 221
static inline void MqttC__send_suback(uint16_t dest, uint8_t topic);
#line 240
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0xb733f628){
#line 102
  switch (arg_0xb733f628) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0xb733f628);
#line 102
      break;
#line 102
    }
...
#line 45
# 128 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static bool Atm128SpiP__ResourceArbiter__isOwner(uint8_t arg_0xb76a7068){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__isOwner(arg_0xb76a7068);
#line 128
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__configure(uint8_t arg_0xb761d010){
#line 59
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__configure(arg_0xb761d010);
#line 59
}
#line 59
...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0xb761e318){
#line 61
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__immediateRequested(arg_0xb761e318);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__immediateRequest(uint8_t arg_0xb76a7068){
#line 97
  unsigned char __nesc_result;
#line 97

#line 97
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__immediateRequest(arg_0xb76a7068);
#line 97
...
# 53 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__requested(uint8_t arg_0xb761e318){
#line 53
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceRequested__default__requested(arg_0xb761e318);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__request(uint8_t arg_0xb76a7068){
#line 88
  unsigned char __nesc_result;
#line 88

#line 88
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__request(arg_0xb76a7068);
#line 88
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0xb7a18730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0xb7a18730, addr, msg, len);
#line 80
...
#line 183
{
  if (!MqttC__current_sub) {
      ;
      MqttC__send_sub(MqttC__interested_topics[MqttC__it_index]);
    }
}
...
#line 190
{
  if (MqttC__it_index < 3) {
      if (!MqttC__subscribed[MqttC__it_index] && MqttC__interested_topics[MqttC__it_index] != 0) {
          ;
          MqttC__current_sub = FALSE;
          MqttC__send_sub(MqttC__interested_topics[MqttC__it_index]);
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0xb73e3708){
#line 83
  switch (arg_0xb73e3708) {
#line 83
    case 1U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0xb73e3708);
#line 83
      break;
#line 83
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0xb72ed088, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0xb72ed088, msg, payload, len);
#line 78
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void MqttC__TimerNextSub__startOneShot(uint32_t dt){
#line 73
...
#line 221
{
  mqtt_packet_t *suback = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));
...
#line 223
  ...
  __nesc_hton_uint8(suback->type.nxdata, SUBACK);

  __nesc_hton_uint16(suback->sender.nxdata, (uint16_t )TOS_NODE_ID);

  __nesc_hton_uint8(suback->topic.nxdata, topic);

  __nesc_hton_uint16(suback->value.nxdata, 0);
...
#line 164
{
  mqtt_packet_t *connack = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));
...
#line 166
  ...
  __nesc_hton_uint8(connack->type.nxdata, CONNACK);

  __nesc_hton_uint16(connack->sender.nxdata, (uint16_t )TOS_NODE_ID);

  __nesc_hton_uint8(connack->topic.nxdata, 0);

  __nesc_hton_uint16(connack->value.nxdata, 0);
...
#line 256
    {
      mqtt_packet_t *mp = (mqtt_packet_t *)payload;

      if (__nesc_ntoh_uint8(mp->type.nxdata) == CONN && TOS_NODE_ID == 1) {
          uint8_t i;
...
#line 262
          ...
          for (i = 0; i < MqttC__cd_index; i++) {
              if (MqttC__connected_devices[MqttC__cd_index] == __nesc_ntoh_uint16(mp->sender.nxdata)) {
          ...
          if (!already_connected) {
              ;
              MqttC__connected_devices[MqttC__cd_index] = __nesc_ntoh_uint16(mp->sender.nxdata);
              MqttC__cd_index++;
            }

          MqttC__send_connack(__nesc_ntoh_uint16(mp->sender.nxdata));
        }
      else {
        if (__nesc_ntoh_uint8(mp->type.nxdata) == CONNACK && TOS_NODE_ID != 1 && MqttC__TimerConn__isRunning()) {
            MqttC__TimerConn__stop();
            ;
            MqttC__connected = TRUE;
            MqttC__TimerNextSub__startOneShot(5000);
          }
        else {
          if (__nesc_ntoh_uint8(mp->type.nxdata) == SUB && TOS_NODE_ID == 1) {
              uint8_t i;
              ...
              for (i = 0; i < MqttC__cd_index; i++) {
                  if (MqttC__connected_devices[i] == __nesc_ntoh_uint16(mp->sender.nxdata)) {
                      node_connected = TRUE;
                      break;
                    }
                }
              ...
              if (node_connected) {
                  if (!MqttC__subscribed_topics[__nesc_ntoh_uint8(mp->topic.nxdata) - 1][__nesc_ntoh_uint16(mp->sender.nxdata) - 2]) {
                      ;
                      MqttC__subscribed_topics[__nesc_ntoh_uint8(mp->topic.nxdata) - 1][__nesc_ntoh_uint16(mp->sender.nxdata) - 2] = TRUE;
                    }
                  MqttC__send_suback(__nesc_ntoh_uint16(mp->sender.nxdata), __nesc_ntoh_uint8(mp->topic.nxdata));
                }
            }
          else {
            if (__nesc_ntoh_uint8(mp->type.nxdata) == SUBACK && TOS_NODE_ID != 1 && MqttC__TimerSub__isRunning()) {
                if (MqttC__interested_topics[MqttC__it_index] == __nesc_ntoh_uint8(mp->topic.nxdata)) {
                    MqttC__TimerSub__stop();
                    ;
                    MqttC__current_sub = TRUE;
                    MqttC__subscribed[MqttC__it_index] = TRUE;
                    MqttC__it_index++;
                    MqttC__TimerNextSub__startOneShot(5000);
                  }
              }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0xb72ee9d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb72ee9d0) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0xb72ee9d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 65 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0xb761d010){
#line 65
    /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__ResourceConfigure__default__unconfigure(arg_0xb761d010);
#line 65
}
#line 65
# 68 "/opt/tinyos-main-2.1.2/tos/system/FcfsResourceQueueC.nc"
...
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t Atm128SpiP__ResourceArbiter__release(uint8_t arg_0xb76a7068){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  __nesc_result = /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__release(arg_0xb76a7068);
#line 120
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void Atm128SpiP__Resource__granted(uint8_t arg_0xb76aa398){
#line 102
  switch (arg_0xb76aa398) {
#line 102
    case 0U:
#line 102
...
#line 102
    default:
#line 102
      Atm128SpiP__Resource__default__granted(arg_0xb76aa398);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Atm128SpiC.Arbiter.Arbiter*/SimpleArbiterP__0__Resource__granted(uint8_t arg_0xb761f8e0){
#line 102
  Atm128SpiP__ResourceArbiter__granted(arg_0xb761f8e0);
#line 102
}
#line 102
...
# 71 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0xb7709b38, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0xb7709b38) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0xb7709b38, data, length, error);
#line 71
      break;
#line 71
    }
...
# 91 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0xb7709b38, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0xb7709b38) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0xb7709b38, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0xb7709108){
#line 102
  switch (arg_0xb7709108) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0xb7709108);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0xb72ee010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0xb72ee010, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0xb7a1bc98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7a1bc98) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0xb7a1bc98, msg, error);
#line 100
      break;
#line 100
    }
...
#line 93
{
  ...
  if (TOS_NODE_ID == 2) {
      MqttC__interested_topics[0] = MqttC__TEMPERATURE;
      MqttC__interested_topics[1] = MqttC__HUMIDITY;
    }

  if (TOS_NODE_ID == 3) {
      MqttC__interested_topics[0] = MqttC__HUMIDITY;
    }

  if (TOS_NODE_ID == 4) {
      MqttC__interested_topics[0] = MqttC__TEMPERATURE;
      MqttC__interested_topics[1] = MqttC__LUMINOSITY;
    }
  ...
  if (TOS_NODE_ID == 8) {
      MqttC__interested_topics[0] = MqttC__TEMPERATURE;
      MqttC__interested_topics[1] = MqttC__HUMIDITY;
      MqttC__interested_topics[2] = MqttC__LUMINOSITY;
    }

  if (TOS_NODE_ID == 9) {
      MqttC__interested_topics[0] = MqttC__LUMINOSITY;
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0xb7befc40){
#line 75
  switch (arg_0xb7befc40) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0xb7befc40);
#line 75
      break;
#line 75
    }
...
#line 200
{
  mqtt_packet_t *sub = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));
...
#line 202
  ...
  __nesc_hton_uint8(sub->type.nxdata, SUB);

  __nesc_hton_uint16(sub->sender.nxdata, (uint16_t )TOS_NODE_ID);

  __nesc_hton_uint8(sub->topic.nxdata, topic);

  __nesc_hton_uint16(sub->value.nxdata, 0);

  MqttC__TimerSub__startOneShot(MqttC__timeout);
...
#line 143
{
  mqtt_packet_t *conn = (mqtt_packet_t *)MqttC__Packet__getPayload(&MqttC__packet, sizeof(mqtt_packet_t ));
...
#line 145
  ...
  __nesc_hton_uint8(conn->type.nxdata, CONN);

  __nesc_hton_uint16(conn->sender.nxdata, (uint16_t )TOS_NODE_ID);

  __nesc_hton_uint8(conn->topic.nxdata, 0);

  __nesc_hton_uint16(conn->value.nxdata, 0);

  MqttC__TimerConn__startOneShot(MqttC__timeout);
